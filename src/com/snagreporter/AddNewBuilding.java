...
import com.snagreporter.AddNewApartment.StartSyncProgress;
import com.snagreporter.AddNewProject.SaveDataToWeb;
...
public class AddNewBuilding extends Activity 
{
	Bitmap myBmp;
	ImageView myImg;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.add_new_building);
        
        menuhandler=new MenuHandler(AddNewBuilding.this);
        ...
        mProgressDialog2 = new ProgressDialog(AddNewBuilding.this);
        ...
        txtBldname=(EditText)findViewById(R.id.addBldng_blgngname);
       // txtNoElvtrs=(EditText)findViewById(R.id.addBldng_noofElvtrs);
       // txtNoFlrs=(EditText)findViewById(R.id.addBldng_noOfFlrs);
       // btnPrjname=(Button)findViewById(R.id.addBldng_prjname);
        
        myImg=(ImageView)findViewById(R.id.addBuild_imgAdd);
	...
	public Boolean istxtValid()
	{
	 ...
	 {
		 ProgressDialog mProgressDialog = new ProgressDialog(AddNewBuilding.this);
			String output="";
			String value="";
		  @Override
		...
		protected Void doInBackground(Integer... params)
		{
			...
			try
			{
				...
				envelope.setOutputSoapObject(request);
				  ...
				  String Values=""+objBld.getID()+"~"+objBld.getBuildingName()+"~"+objBld.getProjectID()+"~"+objBld.getProjectName()+"~"+objBld.getImageName()+"";
		...
		{  
			objBld.setStatusForUpload("Inserted");
			if(isOnline){
		
			//mProgressDialog.dismiss();
			if(value.equalsIgnoreCase("true}}"))
			{
				objBld.setisDataSyncToWeb(true);
				FMDBDatabaseAccess fmdb=new FMDBDatabaseAccess(AddNewBuilding.this);
				fmdb.insertORUpdateBuilding(objBld);
			...
			{
				 new AlertDialog.Builder(AddNewBuilding.this)
				...
				objBld.setisDataSyncToWeb(false);
				FMDBDatabaseAccess fmdb=new FMDBDatabaseAccess(AddNewBuilding.this);
				fmdb.insertORUpdateBuilding(objBld);
				//finish();
			}
	...
	public void SubmitClick(View v)
	{
		if(istxtValid())
		{
			objBld=new BuildingMaster();
			objBld.setBuildingName(txtBldname.getText().toString());
			//objBld.setNoOfElevators(Integer.parseInt(txtNoElvtrs.getText().toString()));
			//objBld.setNoOfFloors(Integer.parseInt(txtNoFlrs.getText().toString()));
			objBld.setProjectName(currentproject.getProjectName());
			objBld.setProjectID(currentproject.getID());
			UUID uuid=UUID.randomUUID();
			objBld.setID(uuid.toString());
			if(Imagename!=null && Imagename.length()>0)
			{
				objBld.setImageName(Imagename);
			}
			else
			{
				objBld.setImageName("");
...
//	 		 	     outStream.close();
			 ...
			 if(url!=null && url.length()!=0 && !url.equals(""))
				{
					...
					try 
					{
						...
						String FilePath=file.toString();
						Bitmap myImg2=BitmapFactory.decodeFile(FilePath);
						byte[] arr=getBytesFromBitmap(myImg2);
	 ...
	 public void ChangeStatusClick(View v){
	    	...
	    	public void ShowChartClick(View v){
	    		try{	
	    			Intent i=new Intent(AddNewBuilding.this,com.snagreporter.GraphWebView.class);
	            	startActivity(i);
	    		}
	    		catch(Exception e){
	    			Log.d("Error=", ""+e.getMessage());
	    	...
	    	public void SyncData(){
	        	...
	        	//task.execute(10);
	    		ParseSyncData parser=new ParseSyncData(AddNewBuilding.this);
	    		parser.start();
	        ...
	        protected class StartSyncProgress extends AsyncTask<Integer , Integer, Void> {
	        	...
	        	boolean result=false;
	                ...
	                protected void onPreExecute() {  
	                	...
	                	FMDBDatabaseAccess db=new FMDBDatabaseAccess(AddNewBuilding.this);
