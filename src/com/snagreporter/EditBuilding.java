...
import com.snagreporter.EditFloor.UpdateDataToWeb;
import com.snagreporter.EditFloor.UploadImageToweb;
...
public class EditBuilding extends Activity 
{
	...
	EditText txtBldname,txtNoFlrs,txtNoElvtrs,txtBldrName,txtPrjName;
	Button btnPrjname;
	//BuildingMaster objBld;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        menuhandler=new MenuHandler(EditBuilding.this);
        ...
        mProgressDialog2 = new ProgressDialog(EditBuilding.this);
        ...
        //objBld=currentbuilding;
        txtBldname=(EditText)findViewById(R.id.editBldng_blgngname);
        myImg=(ImageView)findViewById(R.id.editBldng_imgAdd);
	...
	{
		txtBldname.setText(currentbuilding.getBuildingName());
		oldName=currentbuilding.getBuildingName();
		if(currentbuilding.getImageName()!=null && currentbuilding.getImageName().length()>0)
		{
			Bitmap bmp;
			oldImagename=currentbuilding.getImageName();
	...
	{
		Boolean res;
		if(txtBldname.getText()!=null && txtBldname.getText().toString().length()>0)
		{
			res=true;
		}
		else
	...
	public void SubmitClick(View v)
	{
		if(istxtValid())
		{
			currentbuilding.setBuildingName(txtBldname.getText().toString());
			if(Imagename!=null && Imagename.length()>0)
			{
				currentbuilding.setImageName(Imagename);
				
			}
//			if(oldImagename.equalsIgnoreCase(Imagename) && currentbuilding.getBuildingName().equalsIgnoreCase(oldName))
//			{
...
//	 		 	     outStream.close();
	 ...
	 protected class UpdateDataToWeb extends AsyncTask<Integer , Integer, Void> 
	 {
		 String output = "";
		 String value="";
		 ProgressDialog mProgressDialog = new ProgressDialog(EditBuilding.this);
		 @Override
		protected void onPreExecute() 
		 {
			if(isOnline){
		...
		protected Void doInBackground(Integer... params)
		{
			 ...
			 String METHOD_NAME = "UpdateDataToTheDataBase";
	    		...
	    		try {
	    		    ...
	    		    String Values=""+currentbuilding.getBuildingName()+"~"+currentbuilding.getImageName()+"";
	    		    String TableName="BuildingMaster";
	    		    String KeyColName="ID~ProjectID";
	    		    String ColDataType="String~String";
	    		    String ColValue=""+currentbuilding.getID()+"~"+currentbuilding.getProjectID()+"";
		...
		protected void onPostExecute(Void result) 
		{
			 currentbuilding.setStatusForUpload("Modified");
			 if(isOnline){
				 //mProgressDialog.dismiss();
			 //update data to local database
			 if(value.equalsIgnoreCase("true}}"))
			 {
				 currentbuilding.setisDataSyncToWeb(true);
				 FMDBDatabaseAccess fdb=new FMDBDatabaseAccess(EditBuilding.this);
				 fdb.insertORUpdateBuilding(currentbuilding);
			 ...
			 {
				 new AlertDialog.Builder(EditBuilding.this)
		    	    .setTitle("Update Failed")
				 ...
				 currentbuilding.setisDataSyncToWeb(false);
				 FMDBDatabaseAccess fdb=new FMDBDatabaseAccess(EditBuilding.this);
				 fdb.insertORUpdateBuilding(currentbuilding);
				// finish();
			 }
	 ...
	 public void ChangeStatusClick(View v){
	    	...
	    	public void ShowChartClick(View v){
	    		try{	
	    			Intent i=new Intent(EditBuilding.this,com.snagreporter.GraphWebView.class);
	            	startActivity(i);
	    		}
	    		catch(Exception e){
	    			Log.d("Error=", ""+e.getMessage());
	    	...
	    	public void SyncData(){
	        	...
	        	//task.execute(10);
	    		ParseSyncData parser=new ParseSyncData(EditBuilding.this);
	    		parser.start();
	        }
	        protected class StartSyncProgress extends AsyncTask<Integer , Integer, Void> {
	        	...
	        	boolean result=false;
	                ...
	                protected void onPreExecute() {  
	                	...
	                	FMDBDatabaseAccess db=new FMDBDatabaseAccess(EditBuilding.this);
