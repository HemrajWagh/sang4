...
public class EditApartment extends Activity 
{
	ProjectMaster currentProject;
	BuildingMaster currentBuilding;
	FloorMaster currentFloor;
	ApartmentMaster currentApt;
	//ApartmentMaster objApt;
	ApartmentMaster objEdit;
	String Imagename,oldImageName,oldName;
	EditText txtAptName,txtBldrName,txtPrjName,txtBldgName,tstFlrName;
	Bitmap myBmp;
	ImageView myImg;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.edit_apartment);
        

        menuhandler=new MenuHandler(EditApartment.this);
        ...
        mProgressDialog2 = new ProgressDialog(EditApartment.this);
        ...
        myImg=(ImageView)findViewById(R.id.editApartment_imgAdd);
        txtAptName=(EditText)findViewById(R.id.editAptmnt_aptname);
        
        txtBldrName=(EditText)findViewById(R.id.editPrj_blrname);
        txtPrjName=(EditText)findViewById(R.id.editPrj_prjname);
        txtBldgName=(EditText)findViewById(R.id.editBldng_blgngname);
        tstFlrName=(EditText)findViewById(R.id.editFloor_flrname);
        
        txtBldrName.setText(currentProject.getBuilderName());
        txtPrjName.setText(currentProject.getProjectName());
        txtBldgName.setText(currentBuilding.getBuildingName());
        tstFlrName.setText(currentFloor.getFloor());
	...
	public void populatedata()
	{
		try
		{
		Log.d("aptname",""+currentApt.getApartmentNo());
		txtAptName.setText(currentApt.getApartmentNo());
		//txtAptName.setText(currentApt.getApartmentNo());
		oldName=currentApt.getApartmentNo();
		if(currentApt.getImageName()!=null && currentApt.getImageName().length()>0)
		{
			Bitmap bmp;
			oldImageName=currentApt.getImageName();
	...
	{
		Boolean res;
		if(txtAptName.getText()!=null && txtAptName.getText().toString().length()>0)
		{
			res=true;
		}
		else
	...
	public void SubmitClick(View v)
	{
		if(isTextValid())
		{
			currentApt.setApartmentNo(txtAptName.getText().toString());
			if(Imagename!=null && Imagename.length()>0)
			{
				currentApt.setImageName(Imagename);
				
			}
//			if(oldImageName.equalsIgnoreCase(Imagename) && currentApt.getApartmentNo().equalsIgnoreCase(oldName))
//			{
...
//	 		 	     outStream.close();
	 ...
	 protected class UpdateDataToWeb extends AsyncTask<Integer , Integer, Void> 
	 {
		 String output = "";
		 String value="";
		 ProgressDialog mProgressDialog = new ProgressDialog(EditApartment.this);
		 @Override
		protected void onPreExecute() 
		 {
			if(isOnline){
		...
		protected Void doInBackground(Integer... params)
		{
			 ...
			 String METHOD_NAME = "UpdateDataToTheDataBase";
	    		...
	    		try {
	    		    ...
	    		    String Values=""+currentApt.getApartmentNo()+"~"+currentApt.getImageName();
	    		    ...
	    		    String ColValue=""+currentApt.getID()+"~"+currentApt.getProjectID()+"~"+currentApt.getBuildingID()+"~"+currentApt.getFloorID();
		...
		protected void onPostExecute(Void result) 
		{
			 currentApt.setStatusForUpload("Modified");
			 if(isOnline){
			 //mProgressDialog.dismiss();
			 //update data to local database
			 if(value.equalsIgnoreCase("true}}"))
			 {
				 currentApt.setisDataSyncToWeb(true);
				 FMDBDatabaseAccess fdb=new FMDBDatabaseAccess(EditApartment.this);
				 fdb.insertORUpdateApartment(currentApt);
			 ...
			 {
				 new AlertDialog.Builder(EditApartment.this)
		    	    .setTitle("Update Failed")
				 ...
				 currentApt.setisDataSyncToWeb(false);
				 FMDBDatabaseAccess fdb=new FMDBDatabaseAccess(EditApartment.this);
				 fdb.insertORUpdateApartment(currentApt);
				 //finish();
			 }
	 ...
	 public void ChangeStatusClick(View v){
	    	...
	    	public void ShowChartClick(View v){
	    		try{	
	    			Intent i=new Intent(EditApartment.this,com.snagreporter.GraphWebView.class);
	            	startActivity(i);
	    		}
	    		catch(Exception e){
	    			Log.d("Error=", ""+e.getMessage());
	    	...
	    	public void SyncData(){
	        	...
	        	//task.execute(10);
	    		ParseSyncData parser=new ParseSyncData(EditApartment.this);
	    		parser.start();
	        }
	        protected class StartSyncProgress extends AsyncTask<Integer , Integer, Void> {
	        	...
	        	boolean result=false;
	                ...
	                protected void onPreExecute() {  
	                	...
	                	FMDBDatabaseAccess db=new FMDBDatabaseAccess(EditApartment.this);
