...
import com.snagreporter.AddNewBuilding.UploadImageToweb;
import com.snagreporter.ApartmentListPage.StartSyncProgress;
...
public class AddNewApartment extends Activity
{
	...
	String Imagename;
	EditText txtAptName,txtBldrName,txtPrjName,txtBldgName,txtFlrName;
	Bitmap myBmp;
	ImageView myImg;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.add_new_apartment);
        
        menuhandler=new MenuHandler(AddNewApartment.this);
        ...
        mProgressDialog2 = new ProgressDialog(AddNewApartment.this);
        ...
        myImg=(ImageView)findViewById(R.id.addApartment_imgAdd);
        txtAptName=(EditText)findViewById(R.id.addAptmnt_aptname);
	...
	public void SubmitClick(View v)
	{
		if(istxtValid())
		{
			objApt=new ApartmentMaster();
			objApt.setApartmentNo(txtAptName.getText().toString());
			objApt.setBuildingID(currentBuilding.getID());
			objApt.setBuildingName(currentBuilding.getBuildingName());
			objApt.setProjectID(currentProject.getID());
			objApt.setProjectName(currentProject.getProjectName());
			objApt.setFloor(currentFloor.getFloor());
			objApt.setFloorID(currentFloor.getID());
			UUID uuid=UUID.randomUUID();
			objApt.setID(uuid.toString());
...
//	 		 	     outStream.close();
	 ...
	 {
		 ProgressDialog mProgressDialog = new ProgressDialog(AddNewApartment.this);
			String output="";
			String value;
		  @Override
	        protected void onPreExecute() 
		...
		protected Void doInBackground(Integer... params)
		{
			...
			try
			{
				...
				envelope.setOutputSoapObject(request);
				  ...
				  String Values=""+objApt.getID()+"~"+objApt.getBuildingName()+"~"+objApt.getProjectID()+"~"+objApt.getProjectName()+"~"+objApt.getImageName()+"~"+objApt.getApartmentNo()+"~"+objApt.getBuildingID()+"~"+objApt.getFloor()+"~"+objApt.getFloorID();
        ...
        protected void onPostExecute(Void result)
		{
			objApt.setStatusForUpload("Inserted");
			if(isOnline){
			//mProgressDialog.dismiss();
			if(value.equalsIgnoreCase("true}}"))
			{
				objApt.setisDataSyncToWeb(true);
				FMDBDatabaseAccess fmdb=new FMDBDatabaseAccess(AddNewApartment.this);
			...
			{
				 new AlertDialog.Builder(AddNewApartment.this)
				...
				objApt.setisDataSyncToWeb(false);
				FMDBDatabaseAccess fmdb=new FMDBDatabaseAccess(AddNewApartment.this);
				fmdb.insertORUpdateApartment(objApt);
				//finish();
			}
	 ...
	 public void ChangeStatusClick(View v){
	    	...
	    	public void ShowChartClick(View v){
	    		try{	
	    			Intent i=new Intent(AddNewApartment.this,com.snagreporter.GraphWebView.class);
	            	startActivity(i);
	    		}
	    		catch(Exception e){
	    			Log.d("Error=", ""+e.getMessage());
	    	...
	    	public void SyncData(){
	        	...
	        	//task.execute(10);
	    		ParseSyncData parser=new ParseSyncData(AddNewApartment.this);
	    		parser.start();
	        }
	        protected class StartSyncProgress extends AsyncTask<Integer , Integer, Void> {
	        	...
	        	boolean result=false;
	                ...
	                protected void onPreExecute() {  
	                	...
	                	FMDBDatabaseAccess db=new FMDBDatabaseAccess(AddNewApartment.this);
