...
public class AddNewFloor extends Activity
{
	Bitmap myBmp;
	ImageView myImg;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.add_new_floor);
        
        menuhandler=new MenuHandler(AddNewFloor.this);
        ...
        mProgressDialog2 = new ProgressDialog(AddNewFloor.this);
        ...
        myImg=(ImageView)findViewById(R.id.addFloor_imgAdd);
       // txtAptno=(EditText)findViewById(R.id.addFloor_noOfApts);
        txtFlrname=(EditText)findViewById(R.id.addFloor_flrname);
        //btnbldname=(Button)findViewById(R.id.addFloor_bldngname);
       // btnPrjname=(Button)findViewById(R.id.addFloor_prjname);
        txtAptno=(EditText)findViewById(R.id.addFloor_NoOfflr);
        
        txtPrjName=(EditText)findViewById(R.id.addPrj_prjname);
        txtBldrName=(EditText)findViewById(R.id.addPrj_bldrname);
        txtBldgName=(EditText)findViewById(R.id.addBldng_blgngname);
	...
	public void BackClick(View v){
	 ...
	 {
		 ProgressDialog mProgressDialog = new ProgressDialog(AddNewFloor.this);
			String output="";
			String value="";
		  @Override
		  ...
		  @Override
			protected Void doInBackground(Integer... params)
			{
			  ...
			  if(isOnline){
				...
				String colvalues=""+objFlr.getID()+"~"+objFlr.getProjectName()+"~"+objFlr.getProjectID()+"~"+objFlr.getFloor()+"~"+objFlr.getBuildingID()+"~"+objFlr.getBuildingName()+"~"+objFlr.getImageName()+"~"+objFlr.getNoOfApartments();
	        ...
	        protected void onPostExecute(Void result)
			{
				...
				if(value.equalsIgnoreCase("true}}"))
				{
					...
					FMDBDatabaseAccess fmdb=new FMDBDatabaseAccess(AddNewFloor.this);
				...
				{
					 new AlertDialog.Builder(AddNewFloor.this)
					...
					objFlr.setisDataSyncToWeb(false);
					FMDBDatabaseAccess fmdb=new FMDBDatabaseAccess(AddNewFloor.this);
					fmdb.insertORUpdateFloor(objFlr);
					//finish();
				}
	 ...
	 public void SubmitClick(View v)
	{
			if(istxtValid())
			{
				...
				if(txtAptno.getText()==null || txtAptno.getText().length()==0){
					txtAptno.setText("0");
				}
				
				
				objFlr=new FloorMaster();
				objFlr.setFloor(txtFlrname.getText().toString());
				objFlr.setNoOfApartments(Integer.parseInt(txtAptno.getText().toString()));
				objFlr.setProjectName(CurrentProject.getProjectName());
				objFlr.setBuildingName(CurrentBuilding.getBuildingName());
				objFlr.setBuildingID(CurrentBuilding.getID());
				objFlr.setProjectID(CurrentProject.getID());
				UUID uuid=UUID.randomUUID();
				objFlr.setID(uuid.toString());
				if(ImageName!=null && ImageName.length()>0)
				{
	 ...
	 public void ChooseProjectClick(View v)
	 {
		 index=0;
	 ...
	 public void ChooseBuildingClick(View v)
	 {
		 index=1;
		 registerForContextMenu(v);
		 openContextMenu(v);
	 ...
	 @Override  
	  public void onCreateContextMenu(ContextMenu menu, View v,ContextMenuInfo menuInfo)
	  {
		...
		if(index==0)
		{
			menu.setHeaderTitle("Select Project Name");
			
		}
		else if(index==1)
		{
			menu.setHeaderTitle("Select Building Name");
		}
		else if(index==2)
		{
	  ...
	  public boolean onContextItemSelected(MenuItem item)
	 {
		 if(index==0)
		 {
			 btnPrjname.setText(item.getTitle().toString());
			 return true;
		 }
		 else if(index==1)
		 {
			 btnbldname.setText(item.getTitle().toString());
			 return true;
		 }
		 else if(index==2)
		 {
...
//	 		 	     outStream.close();
	 ...
	 public void ChangeStatusClick(View v){
	    	...
	    	public void ShowChartClick(View v){
	    		try{	
	    			Intent i=new Intent(AddNewFloor.this,com.snagreporter.GraphWebView.class);
	            	startActivity(i);
	    		}
	    		catch(Exception e){
	    			Log.d("Error=", ""+e.getMessage());
	    	...
	    	public void SyncData(){
	        	...
	        	//task.execute(10);
	    		ParseSyncData parser=new ParseSyncData(AddNewFloor.this);
	    		parser.start();
	        }
	        protected class StartSyncProgress extends AsyncTask<Integer , Integer, Void> {
	        	...
	        	boolean result=false;
	                ...
	                protected void onPreExecute() {  
	                	...
	                	FMDBDatabaseAccess db=new FMDBDatabaseAccess(AddNewFloor.this);
