...
import com.snagreporter.EditApartment.UpdateDataToWeb;
import com.snagreporter.EditApartment.UploadImageToweb;
...
public class EditFloor extends Activity 
{
	Bitmap myBmp;
	ImageView myImg;
	Button btnPrjname,btnbldname;
	EditText txtFlrname,txtAptno,txtBldrName,txtPrjName,txtBldgName;
	//FloorMaster objFlr;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.edit_floor);
        
        menuhandler=new MenuHandler(EditFloor.this);
        ...
        mProgressDialog2 = new ProgressDialog(EditFloor.this);
        ...
        //objFlr=CurrentFloor;
        txtFlrname=(EditText)findViewById(R.id.editFloor_flrname);
        myImg=(ImageView)findViewById(R.id.editFloor_imgAdd);
	...
	{
		txtFlrname.setText(CurrentFloor.getFloor());
		oldName=CurrentFloor.getFloor();
		if(CurrentFloor.getImageName()!=null && CurrentFloor.getImageName().length()>0)
		{
			Bitmap bmp;
			oldImageName=CurrentFloor.getImageName();
	...
	public void SubmitClick(View v)
	{
		if(istxtValid())
		{
			CurrentFloor.setFloor(txtFlrname.getText().toString());
			if(Imagename!=null && Imagename.length()>0)
			{
				CurrentFloor.setImageName(Imagename);
				
			}
//			if(oldImageName.equalsIgnoreCase(Imagename) && CurrentFloor.getFloor().equalsIgnoreCase(oldName))
//			{
...
//			{
	...
	{
		Boolean res;
		if(txtFlrname.getText()!=null && txtFlrname.getText().toString().length()>0)
		{
			res=true;
		}
		else
...
//	 		 	     outStream.close();
	 ...
	 protected class UpdateDataToWeb extends AsyncTask<Integer , Integer, Void> 
	 {
		 String output = "";
		 String value="";
		 ProgressDialog mProgressDialog = new ProgressDialog(EditFloor.this);
		 @Override
		protected void onPreExecute() 
		 {
			if(isOnline){
		...
		protected Void doInBackground(Integer... params)
		{
			 ...
			 String METHOD_NAME = "UpdateDataToTheDataBase";
	    		...
	    		try {
	    		    ...
	    		    String Values=""+CurrentFloor.getFloor()+"~"+CurrentFloor.getImageName();
	    		    String TableName="FloorMaster";
	    		    String KeyColName="ID~ProjectID~BuildingID";
	    		    String ColDataType="String~String~String";
	    		    String ColValue=""+CurrentFloor.getID()+"~"+CurrentFloor.getProjectID()+"~"+CurrentFloor.getBuildingID();
		...
		protected void onPostExecute(Void result) 
		{
			 CurrentFloor.setStatusForUpload("Modified");
			 if(isOnline){
			// mProgressDialog.dismiss();
			 //update data to local database
			 if(value.equalsIgnoreCase("true}}"))
			 {
				 CurrentFloor.setisDataSyncToWeb(true);
				 FMDBDatabaseAccess fdb=new FMDBDatabaseAccess(EditFloor.this);
				 fdb.insertORUpdateFloor(CurrentFloor);
			 ...
			 {
				 new AlertDialog.Builder(EditFloor.this)
		    	    .setTitle("Update Failed")
				 ...
				 CurrentFloor.setisDataSyncToWeb(false);
				 FMDBDatabaseAccess fdb=new FMDBDatabaseAccess(EditFloor.this);
				 fdb.insertORUpdateFloor(CurrentFloor);
				// finish();
			 }
	 ...
	 public void ChangeStatusClick(View v){
	    	...
	    	public void ShowChartClick(View v){
	    		try{	
	    			Intent i=new Intent(EditFloor.this,com.snagreporter.GraphWebView.class);
	            	startActivity(i);
	    		}
	    		catch(Exception e){
	    			Log.d("Error=", ""+e.getMessage());
	    	...
	    	public void SyncData(){
	        	...
	        	//task.execute(10);
	    		ParseSyncData parser=new ParseSyncData(EditFloor.this);
	    		parser.start();
	        }
	        protected class StartSyncProgress extends AsyncTask<Integer , Integer, Void> {
	        	...
	        	boolean result=false;
	                ...
	                protected void onPreExecute() {  
	                	...
	                	FMDBDatabaseAccess db=new FMDBDatabaseAccess(EditFloor.this);
